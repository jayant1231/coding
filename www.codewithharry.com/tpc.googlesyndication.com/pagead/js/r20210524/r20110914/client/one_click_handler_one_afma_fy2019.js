(function() {
    ...
    */
            ...
            try {
                ...
                if (h.location && h.location.ancestorOrigins && h.location.ancestorOrigins.length == l.length - 1)
                    for (m = 1; m < l.length; ++m) {
                        var w = l[m];
                        w.url || (w.url = h.location.ancestorOrigins[m - 1] || "", w.H = !0)
                    }
                var x = l;
                ...
                E = null;
                const Ec = x.length && x[Ea].url;
                0 != ma.depth && Ec && (E = x[Ea]);
                f = new Tb(ma, E);
                if (f.h) {
                    x = D;
                    var I = f.h.url || "";
    ...
    var tc = (a, b) => {
        ...
        vc = (a, b, c, d) => {
            ...
            if (0 < e.length) {
                if (null != F(b, 18)) {
                    c = 609 === d;
                    var f = c ? 1 : void 0 !== P.featurePolicy && P.featurePolicy.allowsFeature("conversion-measurement") ? 3 : 2;
                    var g = f.toString();
                    f = encodeURIComponent("nis");
                    g = encodeURIComponent(String(g));
                    e = e.replace("?", "?" + f + "=" + g + "&");
                    if (c || !a.hasAttribute("impressiondata")) c = N(b, La, 18), a.setAttribute("conversiondestination", J(c, 2)), a.setAttribute("impressiondata", J(c, 1)), a.setAttribute("reportingorigin", J(c, 3)), a.setAttribute("impressionexpiry", J(c, 4))
                }
                u(a, Ob(e, Pb(d)));
                a.target || (a.target = null != F(b, 11) ? J(b, 11) : "_top")
            }
        },
        wc = a => {
            var b = void 0 === b ? "" : b;
            for (const d of a) {
                ...
                "A" != d.element.tagName ||
                    K(a, 1) || c || (c = d.element, vc(c, a, c.href, 609))
            }
        },
        xc = a => {
        ...
        yc = (a, b) => {
            ...
            const c = [],
                d = [];
            for (var e of a)(a = e.data) && null != F(a, 12) && (d.push(N(a, Pa, 12)), c.push(N(a, Pa, 12).s()));
            e = (f, g) => {
                if (g)
        ...
        Ac = (a, b, c, d, e) => {
            ...
            if (K(N(b, Pa, 12), 2)) return zc({
                ...
                isDeepLinkPath: !1,
                exptIds: e
            }), d.click(c), d.openAndroidApp(f), setTimeout(() => {
                var g = {
                    id: "gmob-apps",
        ...
        Bc = (a, b, c, d, e, f) => {
            ...
            ya(L(c, 10, null), (l, h) => {
                ...
                console.log(x);
                h = h + "=" + w;
                k = x ? m.replace(l, x[0].charAt(0) + h) : m.replace("?", "?" + h + "&")
            });
            zc({
                id: "gmob-apps",
            ...
            else if (null == b ? 0 : K(b,
                    1))(null == b ? 0 : K(b, 5)) ? c = l => e.openStoreOverlay(l, () => e.openSKOverlayWithUrl(k)) : c = e.openStoreOverlay;
    ...
    function Mc(a, b, c, d) {
        if (!K(d, 13)) {
            var e = window;
            e.pawsig && "function" === typeof e.pawsig.clk && e.pawsig.clk(c);
            e = c.href;
            var f = /[?&]adurl=([^&]+)/.exec(e);
            ...
            a.i &&
                "function" === typeof window.ss && (a.G ? window.ss(f, 1, a.i) : window.ss(a.i, 1));
